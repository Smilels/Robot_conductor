...
void switch_arm_vel_controllers(ros::NodeHandle &nh, bool left_teleop, bool right_teleop) {
    ...
    ros::ServiceClient loadClient = nh.serviceClient<controller_manager_msgs::LoadController>(
...
int main(int argc, char **argv) {
    ros::init(argc, argv, "arm_group_velocity_controllers_switch");
    ros::NodeHandle nh;
    ...
    ros::Rate rate(5.0);
    std::cout << "Switch arm controller to group velocity controller!" << std::endl;
    return 0;
}
