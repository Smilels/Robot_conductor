...
class Map_Loader(object):
    ...
    def map(self, start):
        ...
        return frame, rh_tip_pip_key/1000, rh_pip_mcp_key/1000, pip_mcp/1000, \
               tip_pip/1000, local_points, shadow_points, keypoints[0], np.hstack([wrist_x, wrist_y, wrist_z])
